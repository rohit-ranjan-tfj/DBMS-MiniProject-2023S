...
def generate_receipt(order_id):
    try:
        ...
        if order_obj is not None and movie_obj is not None and user_obj is not None:
            ...
            receipt.cell(200, 10, 'HMS Movie Rentals', 0, 1, 'C')
...
# Utility function to return a list of all orders that the user has created on the HMS.
...
# Utility function to generate a PDF audit report of all orders on the HMS.
def audit():
    auditpdf = FPDF()
    try:
        auditpdf.add_page()
        ...
        auditpdf.cell(200, 10, 'HMS Movie Rentals', 0, 1, 'C')
